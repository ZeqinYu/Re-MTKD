...
from Cue_Net.model.encoder import get_convnextv2
...
class UperNet_6_d1(nn.Module):
    def __init__(self, num_classes=1, backbone='convnextv2_large_22k_224', pretrained=True, activation=nn.Sigmoid(), freeze_backbone=False):
